...
public class Client extends AbstractTestBooking {
	...
	protected void checkForAvailableCarTypes(Date start, Date end) throws Exception {
		Set<CarType> carTypes = crc.getAvailableCarTypes(start, end);
		for(CarType type:carTypes){
			System.out.println("CarType: " + type.getName());
	...
	protected int getNumberOfReservationsForCarType(String carType) throws Exception {
		int amount = crc.getNumberOfReservationsForCarType(carType);
		System.out.println("There are " + amount + "reservations for carType: " + carType);
		return amount ;
	}
}